...
test('physical folders are the Volta shelf, level for level',()=>{
  ...
  assert.equal(genshin.relative,'曲谱/原神/璃月/原神 - 神女劈观 · aaaaaaaa.pdf');
  ...
  assert.equal(classical.relative,'曲谱/王建中/王建中 - 彩云追月 · dddddddd.pdf');
  ...
  assert.equal(honkai.relative,'曲谱/崩坏3/崩坏3 - Rubia · hhhhhhhh.pdf');
  ...
  assert.equal(pending.relative,'曲谱/作曲家待核对/作曲待核对 - 未知作品 · jjjjjjjj.pdf');
});
